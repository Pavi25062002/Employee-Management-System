...
const Admin = () => {
  return (
    <ul className="sidebar-menu">
      ...
      <li><NavLink className="nav-link" to="/tasklists"><i class="fas fa-piggy-bank"></i> <span>task Management</span></NavLink></li>
      <li><NavLink className="nav-link" to="/taskdashboard"><i class="fas fa-piggy-bank"></i> <span>task dashboard</span></NavLink></li>
      ...
      <li><NavLink className="nav-link" to="/creatask"><i className="far fa-square"></i> <span>Create Task</span></NavLink></li>
